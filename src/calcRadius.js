...
let radius = (tntWeight) => {
  ...
  let r0 = (pow(tntWeight / 1000, 0.37) * 13.6).toFixed(2);
  let r1 = (pow(e * 1000 / p0, 1 / 3) * z1).toFixed(2);
  let r2 = (pow(e * 1000 / p0, 1 / 3) * z2).toFixed(2);
  let r3 = (k * pow(tntWeight, 1 / 3) / (pow(1 + (3175 / tntWeight) * 2, 1 / 6))).toFixed(2);
  return {
    r0,
    r1,
    r2,
